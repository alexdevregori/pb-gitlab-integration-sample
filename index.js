...
app.post("/plugin", async (req, res) => {
    ...
    if (req.body.data.trigger === "button.push") {
        ...
        getProductboardFeature(pbFeatureID).then(pbFeatureResponse => {
            ...
            createGitlabIssue(featureName, featureDescription + featureLinkHtml).then(gitlabIssueResponse => {
...
app.post("/gitlab-webhook", async (req, _) => {
    ...
    getProductboardPluginIntegrationsConnections().then(pbConnectionsResponse => {
